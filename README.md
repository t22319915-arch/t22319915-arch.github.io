...
6a. [上傳主日週報／換新人表單／改奉獻帳號](#6a-上傳主日週報換新人表單改奉獻帳號)
7. [網站地圖](#7-網站地圖)
...
## 6a. 上傳主日週報／換新人表單／改奉獻帳號

**上傳週報（每週約 30 秒）**：後台 → **主日週報** → **新增**：標題如 `2503期 2026.09.20`、
日期選當週主日、**週報 PDF** 上傳電子檔 → 發布。首頁「最新週報」與週報專區自動更新。

**換新人表單**：後台 → **網站基本設定** → **基本資料** → **新人表單連結**：貼上 Google 表單的
「傳送」連結 → 發布，新人專區自動嵌入。空白則只顯示電話。

**新人表單即時通知**：到 Google 表單「回覆」頁籤 → 右上 ⋮ →「有新回覆時透過電子郵件通知我」打開，
通知會寄到建表單的 Google 帳號（請用 tcfc.tw@gmail.com 建表單）。

**改奉獻帳號**：同上基本資料 → **奉獻銀行／帳號／戶名／備註** → 發布，奉獻頁同步更新。
...
| 路徑 | 說明 |
| ---- | ---- |
| `/` | 首頁：Hero、最新公告、本週直播、近期消息、最新週報、聚會時間、牧師／相簿預覽 |
| `/welcome` | 第一次來：新人 Q&A、交通方式、新人留資料表單 |
| `/giving` | 奉獻支持：轉帳帳號、戶名、一鍵複製 |
| `/bulletins` | 主日週報列表（PDF 閱讀／下載） |
